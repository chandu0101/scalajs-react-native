...
object NavigatorS {
  ...
  val NavigationBar: js.Object = ReactNative.Navigator.asInstanceOf[js.Dynamic].NavigationBar.asInstanceOf[js.Object]
  val BreadcrumbNavigationBar: js.Object = ReactNative.Navigator.asInstanceOf[js.Dynamic].BreadcrumbNavigationBar.asInstanceOf[js.Object]
...
case class NavigatorRoute(id: js.UndefOr[String] = js.undefined,
                          ...
                          title: String,
                           component: ReactComponentC.ReqProps[Any,_,_,TopNode],
...
object NavigatorRoute {
  def fromJson(obj : js.Dynamic) = NavigatorRoute( sceneConfig = if(js.isUndefined(obj.sceneConfig)) js.undefined else obj.sceneConfig,
    component = obj.component.asInstanceOf[ReactComponentC.ReqProps[Any,_,_,TopNode]],
